...
for(var i=0;i<sidebarLeftLi.length;i++)
{
	...
	sidebarLeftLi[i].onmouseover=function()
	{
		for(var j=0;j<sidebarLeftLi.length;j++)
		{
			...
			animate(sidebarLeftLiCon[j],{left:0},600,Tween.Linear);
		...
		animate(sidebarLeftLiCon[this.index],{left:10},600,Tween.Linear);
	}
	sidebarLeftLi[i].onmouseout=function()
	{
		for(var i=0;i<sidebarLeftLi.length;i++)
		{
			...
			animate(sidebarLeftLiCon[i],{left:0},600,Tween.Linear);
		}
